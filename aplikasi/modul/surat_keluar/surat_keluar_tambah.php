...
if(isset($_POST['submit'])) {
	...
	if(empty($form_error)) {
		...
		$insert = $db->tambah('tbl_surat_keluar', $data);
		if($insert > 0) {
			set_notif('simpan_ok', 1);
			redirect('?m=surat_keluar');
		} else {
...
set_web('judul', 'Tambah Data Surat Keluar');
load_script('select2');
	...
	<div class="col-md-12">
		<div class="box box-success">
			<div class="box-header with-border" align="center">
				<h3 class="box-title" style=""><b>Tambah Data Surat Keluar</b></h3>
			...
			<form method="POST">
				<div class="box-body">
					...
					<div class="form-group">
						...
						<div class="input-group">
							...
							<input type="text" placeholder="Masukan Tanggal Kirim" id="tgl_kirim" name="tgl_kirim" class="form-control datepicker">
						</div>
					</div>
					...
					<div class="form-group">
						<label for="petugas_pengirim"> Petugas Pengirim </label>
						<br>

						<select id="petugas_pengirim" name="petugas_pengirim" class="form-control select2" style="width : 200px;">
				...
				<div class="box-footer">
					...
					<a href="<?php echo site_url('?m=surat_keluar');?>" class="btn btn-warning btn-sm pull-right"> <i class="fa fa-angle-double-left"></i> Kembali </a>
				</div>
			</form>
